          ...
          {showModal && (
            <div className={style.recipeModal}>
              <div className={style.recipeModalContent}>
                ...
                <p>
                  <span className={style.label}>מנות:</span> {formData.servings}
                </p>
                <p>
                  <span className={style.label}>סוג:</span> {formData.type}
                </p>
                <p>
                  <span className={style.label}>זמן:</span> {formData.time}
                </p>
                <p>
                ...
                <p>
                  <span className={style.label}>הוראות:</span>{" "}
                  {formData.directions.join(", ")}
                </p>
                <p>
                ...
                <button
                  ...
                  className={style.modelSubmitButton}
                >
                  אישור סופי
                </button>
                <button
